...
abstract class BaseGrupoPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdGrupo', 'IdOrden', 'IdMesa', 'Descripcion', 'FechaCreacion', 'Estado', 'Tipo', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idGrupo', 'idOrden', 'idMesa', 'descripcion', 'fechaCreacion', 'estado', 'tipo', ),
		BasePeer::TYPE_COLNAME => array (self::ID_GRUPO, self::ID_ORDEN, self::ID_MESA, self::DESCRIPCION, self::FECHA_CREACION, self::ESTADO, self::TIPO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_GRUPO', 'ID_ORDEN', 'ID_MESA', 'DESCRIPCION', 'FECHA_CREACION', 'ESTADO', 'TIPO', ),
		BasePeer::TYPE_FIELDNAME => array ('id_grupo', 'id_orden', 'id_mesa', 'descripcion', 'fecha_creacion', 'estado', 'tipo', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdGrupo' => 0, 'IdOrden' => 1, 'IdMesa' => 2, 'Descripcion' => 3, 'FechaCreacion' => 4, 'Estado' => 5, 'Tipo' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idGrupo' => 0, 'idOrden' => 1, 'idMesa' => 2, 'descripcion' => 3, 'fechaCreacion' => 4, 'estado' => 5, 'tipo' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID_GRUPO => 0, self::ID_ORDEN => 1, self::ID_MESA => 2, self::DESCRIPCION => 3, self::FECHA_CREACION => 4, self::ESTADO => 5, self::TIPO => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_GRUPO' => 0, 'ID_ORDEN' => 1, 'ID_MESA' => 2, 'DESCRIPCION' => 3, 'FECHA_CREACION' => 4, 'ESTADO' => 5, 'TIPO' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id_grupo' => 0, 'id_orden' => 1, 'id_mesa' => 2, 'descripcion' => 3, 'fecha_creacion' => 4, 'estado' => 5, 'tipo' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(GrupoPeer::ID_ORDEN);
			$criteria->addSelectColumn(GrupoPeer::ID_MESA);
			$criteria->addSelectColumn(GrupoPeer::DESCRIPCION);
			$criteria->addSelectColumn(GrupoPeer::FECHA_CREACION);
			$criteria->addSelectColumn(GrupoPeer::ESTADO);
			$criteria->addSelectColumn(GrupoPeer::TIPO);
		} else {
			$criteria->addSelectColumn($alias . '.ID_GRUPO');
	...
	/**
	 * Returns the number of rows matching criteria, joining the related Mesa table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinMesa(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(GrupoPeer::ID_MESA, MesaPeer::ID_MESA, $join_behavior);
	...
	public static function doCountJoinOrden(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(GrupoPeer::ID_ORDEN, OrdenPeer::ID_ORDEN, $join_behavior);
	...
	/**
	 * Selects a collection of Grupo objects pre-filled with their Mesa objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Grupo objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinMesa(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		GrupoPeer::addSelectColumns($criteria);
		$startcol = GrupoPeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = GrupoPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = GrupoPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://www.propelorm.org/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				GrupoPeer::addInstanceToPool($obj1, $key1);
			} // if $obj1 already loaded

			$key2 = MesaPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = MesaPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					MesaPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded

				// Add the $obj1 (Grupo) to $obj2 (Mesa)
				$obj2->addGrupo($obj1);
	...
	/**
	 * Selects a collection of Grupo objects pre-filled with their Orden objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Grupo objects.
	...
	public static function doSelectJoinOrden(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Grupo) to $obj2 (Orden)
				$obj2->addGrupo($obj1);
	...
	/**
	 * Selects a collection of Grupo objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		GrupoPeer::addSelectColumns($criteria);
		$startcol2 = GrupoPeer::NUM_HYDRATE_COLUMNS;

		MesaPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + MesaPeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined Mesa rows

			$key2 = MesaPeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = MesaPeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (Grupo) to the collection in $obj2 (Mesa)
				$obj2->addGrupo($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Grupo) to the collection in $obj3 (Orden)
				$obj3->addGrupo($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptMesa(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Grupo objects pre-filled with all related objects except Mesa.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptMesa(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = GrupoPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Grupo) to the collection in $obj2 (Orden)
				$obj2->addGrupo($obj1);
	...
	/**
	 * Selects a collection of Grupo objects pre-filled with all related objects except Orden.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(GrupoPeer::ID_GRUPO);
			if ($value) {
				$selectCriteria->add(GrupoPeer::ID_GRUPO, $value, $comparison);
			} else {
