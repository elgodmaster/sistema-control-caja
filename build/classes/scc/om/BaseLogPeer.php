...
abstract class BaseLogPeer {
	...
	const ID_LOG = 'log.ID_LOG';

	/** the column name for the ID_PERSONA field */
	const ID_PERSONA = 'log.ID_PERSONA';

	/** the column name for the FECHA_HORA field */
	const FECHA_HORA = 'log.FECHA_HORA';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdLog', 'IdPersona', 'FechaHora', 'Modulo', 'Detalle', 'Accion', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idLog', 'idPersona', 'fechaHora', 'modulo', 'detalle', 'accion', ),
		BasePeer::TYPE_COLNAME => array (self::ID_LOG, self::ID_PERSONA, self::FECHA_HORA, self::MODULO, self::DETALLE, self::ACCION, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_LOG', 'ID_PERSONA', 'FECHA_HORA', 'MODULO', 'DETALLE', 'ACCION', ),
		BasePeer::TYPE_FIELDNAME => array ('id_log', 'id_persona', 'fecha_hora', 'modulo', 'detalle', 'accion', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdLog' => 0, 'IdPersona' => 1, 'FechaHora' => 2, 'Modulo' => 3, 'Detalle' => 4, 'Accion' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idLog' => 0, 'idPersona' => 1, 'fechaHora' => 2, 'modulo' => 3, 'detalle' => 4, 'accion' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID_LOG => 0, self::ID_PERSONA => 1, self::FECHA_HORA => 2, self::MODULO => 3, self::DETALLE => 4, self::ACCION => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_LOG' => 0, 'ID_PERSONA' => 1, 'FECHA_HORA' => 2, 'MODULO' => 3, 'DETALLE' => 4, 'ACCION' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id_log' => 0, 'id_persona' => 1, 'fecha_hora' => 2, 'modulo' => 3, 'detalle' => 4, 'accion' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(LogPeer::ID_LOG);
			$criteria->addSelectColumn(LogPeer::ID_PERSONA);
			$criteria->addSelectColumn(LogPeer::FECHA_HORA);
			$criteria->addSelectColumn(LogPeer::MODULO);
			$criteria->addSelectColumn(LogPeer::DETALLE);
			$criteria->addSelectColumn(LogPeer::ACCION);
		} else {
	...
	public static function doCountJoinPersona(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(LogPeer::ID_PERSONA, PersonaPeer::ID_PERSONA, $join_behavior);
	...
	/**
	 * Selects a collection of Log objects pre-filled with their Persona objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinPersona(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		LogPeer::addSelectColumns($criteria);
		$startcol = LogPeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to $obj2 (Persona)
				$obj2->addLog($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		LogPeer::addSelectColumns($criteria);
		$startcol2 = LogPeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to the collection in $obj2 (Persona)
				$obj2->addLog($obj1);
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(LogPeer::ID_LOG) && $criteria->keyContainsValue(LogPeer::ID_LOG) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(LogPeer::ID_LOG);
			$value = $criteria->remove(LogPeer::ID_LOG);
			if ($value) {
				$selectCriteria->add(LogPeer::ID_LOG, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(LogPeer::ID_LOG, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(LogPeer::ID_LOG, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(LogPeer::DATABASE_NAME);
			$criteria->add(LogPeer::ID_LOG, $pks, Criteria::IN);
