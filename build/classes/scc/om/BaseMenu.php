...
abstract class BaseMenu extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the id_menu_padre field.
	 * @var        int
	 */
	...
	/**
	 * Get the [id_menu_padre] column value.
	 * 
	 * @return     int
	 */
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = MenuPeer::DESCRIPCION;
		}
	...
	/**
	 * Set the value of [id_menu_padre] column.
	 * 
	 * @param      int $v new value
	 * @return     Menu The current object (for fluent API support)
	 */
	public function setIdMenuPadre($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->id_menu_padre !== $v) {
			$this->id_menu_padre = $v;
			$this->modifiedColumns[] = MenuPeer::ID_MENU_PADRE;
		}
	...
	public function setNivel($v)
	{
		...
		if ($this->nivel !== $v) {
			$this->nivel = $v;
			$this->modifiedColumns[] = MenuPeer::NIVEL;
		}
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v) {
			$this->estado = $v;
			$this->modifiedColumns[] = MenuPeer::ESTADO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_menu_padre = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->link = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->nivel = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			...
			return $startcol + 7; // 7 = MenuPeer::NUM_HYDRATE_COLUMNS.
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setIdMenuPadre($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MenuPeer::DESCRIPCION)) $criteria->add(MenuPeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(MenuPeer::ID_MENU_PADRE)) $criteria->add(MenuPeer::ID_MENU_PADRE, $this->id_menu_padre);
		if ($this->isColumnModified(MenuPeer::LINK)) $criteria->add(MenuPeer::LINK, $this->link);
		if ($this->isColumnModified(MenuPeer::NIVEL)) $criteria->add(MenuPeer::NIVEL, $this->nivel);
		if ($this->isColumnModified(MenuPeer::ORDEN)) $criteria->add(MenuPeer::ORDEN, $this->orden);
		if ($this->isColumnModified(MenuPeer::ESTADO)) $criteria->add(MenuPeer::ESTADO, $this->estado);
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setIdMenuPadre($this->getIdMenuPadre());
	 ...
	 * @return     PropelCollection|array MenuPersona[] List of MenuPersona objects
	 */
	public function getMenuPersonasJoinPersona($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = MenuPersonaQuery::create(null, $criteria);
