...
abstract class BaseOrden extends BaseObject  implements Persistent
{
	...
	public function setIdOrden($v)
	{
		...
		if ($this->id_orden !== $v) {
			$this->id_orden = $v;
			$this->modifiedColumns[] = OrdenPeer::ID_ORDEN;
		}
	...
	public function setIdCuadreCaja($v)
	{
		...
		if ($this->id_cuadre_caja !== $v) {
			...
			$this->modifiedColumns[] = OrdenPeer::ID_CUADRE_CAJA;
		}
	...
	public function setIdPersona($v)
	{
		...
		if ($this->id_persona !== $v) {
			$this->id_persona = $v;
			$this->modifiedColumns[] = OrdenPeer::ID_PERSONA;
		}
	...
	public function setFechaHora($v)
	{
		...
		if ($this->fecha_hora !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = OrdenPeer::FECHA_HORA;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_orden = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 4; // 4 = OrdenPeer::NUM_HYDRATE_COLUMNS.
	...
	{
		if (isset($alreadyDumpedObjects['Orden'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Orden'][$this->getPrimaryKey()] = true;
		$keys = OrdenPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdOrden(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdOrden($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OrdenPeer::ID_ORDEN)) $criteria->add(OrdenPeer::ID_ORDEN, $this->id_orden);
		if ($this->isColumnModified(OrdenPeer::ID_CUADRE_CAJA)) $criteria->add(OrdenPeer::ID_CUADRE_CAJA, $this->id_cuadre_caja);
		if ($this->isColumnModified(OrdenPeer::ID_PERSONA)) $criteria->add(OrdenPeer::ID_PERSONA, $this->id_persona);
		if ($this->isColumnModified(OrdenPeer::FECHA_HORA)) $criteria->add(OrdenPeer::FECHA_HORA, $this->fecha_hora);
	...
	{
		$criteria = new Criteria(OrdenPeer::DATABASE_NAME);
		$criteria->add(OrdenPeer::ID_ORDEN, $this->id_orden);
	...
	/**
	 * Generic method to set the primary key (id_orden column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		if ($makeNew) {
			$copyObj->setNew(true);
			$copyObj->setIdOrden(NULL); // this is a auto-increment column, so set to default value
		}
	}
	...
	public function getCuadreCaja(PropelPDO $con = null)
	{
		if ($this->aCuadreCaja === null && ($this->id_cuadre_caja !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aCuadreCaja->addOrdens($this);
			 */
		}
	 ...
	 * If this Orden is new, it will return
	 ...
	 * @return     PropelCollection|array Factura[] List of Factura objects
	 */
	public function getFacturasJoinCliente($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = FacturaQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array Grupo[] List of Grupo objects
	 */
	public function getGruposJoinMesa($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GrupoQuery::create(null, $criteria);
		$query->joinWith('Mesa', $join_behavior);
	 ...
	 * @return     PropelCollection|array DetalleOrden[] List of DetalleOrden objects
	 */
	public function getDetalleOrdensJoinPersona($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = DetalleOrdenQuery::create(null, $criteria);
	...
	{
		return (string) $this->exportTo(OrdenPeer::DEFAULT_STRING_FORMAT);
	}
