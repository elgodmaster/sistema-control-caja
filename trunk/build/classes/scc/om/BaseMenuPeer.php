...
abstract class BaseMenuPeer {
	...
	const DESCRIPCION = 'menu.DESCRIPCION';

	/** the column name for the ID_MENU_PADRE field */
	const ID_MENU_PADRE = 'menu.ID_MENU_PADRE';

	/** the column name for the LINK field */
	const LINK = 'menu.LINK';

	/** the column name for the NIVEL field */
	const NIVEL = 'menu.NIVEL';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdMenu', 'Descripcion', 'IdMenuPadre', 'Link', 'Nivel', 'Orden', 'Estado', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idMenu', 'descripcion', 'idMenuPadre', 'link', 'nivel', 'orden', 'estado', ),
		BasePeer::TYPE_COLNAME => array (self::ID_MENU, self::DESCRIPCION, self::ID_MENU_PADRE, self::LINK, self::NIVEL, self::ORDEN, self::ESTADO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_MENU', 'DESCRIPCION', 'ID_MENU_PADRE', 'LINK', 'NIVEL', 'ORDEN', 'ESTADO', ),
		BasePeer::TYPE_FIELDNAME => array ('id_menu', 'descripcion', 'id_menu_padre', 'link', 'nivel', 'orden', 'estado', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdMenu' => 0, 'Descripcion' => 1, 'IdMenuPadre' => 2, 'Link' => 3, 'Nivel' => 4, 'Orden' => 5, 'Estado' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idMenu' => 0, 'descripcion' => 1, 'idMenuPadre' => 2, 'link' => 3, 'nivel' => 4, 'orden' => 5, 'estado' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID_MENU => 0, self::DESCRIPCION => 1, self::ID_MENU_PADRE => 2, self::LINK => 3, self::NIVEL => 4, self::ORDEN => 5, self::ESTADO => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_MENU' => 0, 'DESCRIPCION' => 1, 'ID_MENU_PADRE' => 2, 'LINK' => 3, 'NIVEL' => 4, 'ORDEN' => 5, 'ESTADO' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id_menu' => 0, 'descripcion' => 1, 'id_menu_padre' => 2, 'link' => 3, 'nivel' => 4, 'orden' => 5, 'estado' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(MenuPeer::DESCRIPCION);
			$criteria->addSelectColumn(MenuPeer::ID_MENU_PADRE);
			$criteria->addSelectColumn(MenuPeer::LINK);
			$criteria->addSelectColumn(MenuPeer::NIVEL);
			$criteria->addSelectColumn(MenuPeer::ORDEN);
			$criteria->addSelectColumn(MenuPeer::ESTADO);
		} else {
			$criteria->addSelectColumn($alias . '.ID_MENU');
			$criteria->addSelectColumn($alias . '.DESCRIPCION');
			$criteria->addSelectColumn($alias . '.ID_MENU_PADRE');
