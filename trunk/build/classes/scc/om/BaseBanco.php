...
abstract class BaseBanco extends BaseObject  implements Persistent
{
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v) {
			$this->estado = $v;
			$this->modifiedColumns[] = BancoPeer::ESTADO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_banco = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 3; // 3 = BancoPeer::NUM_HYDRATE_COLUMNS.
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(BancoPeer::ID_BANCO) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BancoPeer::ESTADO)) $criteria->add(BancoPeer::ESTADO, $this->estado);
